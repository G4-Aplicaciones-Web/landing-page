            ...
            <div className="flex flex-wrap">
              <div className="bg-sky-green px-8 pt-4 pb-8 rounded-lg overflow-hidden text-center relative">
                <div className="flex flex-wrap justify-center max-w-4xl font-bold">
                  <div className="text-[36px] mt-9 mb-15">¿Cómo funciona?</div>
                  <div className="text-[24px] flex flex-col text-left gap-y-8 mb-9">
                    <div>
                      1. Responde un breve cuestionario sobre tus metas y
                      preferencias
                    </div>
                    <div>
                      2. Recibe tu plan de alimentación personalizado en segundos
                    </div>
                    <div>
                      3. Ajusta y sigue tu progreso con herramientas simples y
                      visuales
                    </div>
                  </div>
                </div>
